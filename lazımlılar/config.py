...
admin_qrup = int(os.environ.get("-960446527"))
etiraf_qrup = int(os.environ.get("-1001573804378"))
kanal = os.environ.get("LunaEtiraflar")
log_group = int(os.environ.get("-845532090"))
botad = os.environ.get("LunaMultibot")
etirafmsg = os.environ.get("Etirafını necə paylaşım ?")
startmsg = os.environ.get("Salam, Xoş Gəldin __Heçkimə demədiyin etirafları mənə deyə bilərsən_")
...
gonderildi = os.environ.get("Etirafınız göndərildi Adminlər tərəfindən təsdiq olunduqdan sonra @LunaEtiraflar kanalında paylaşılacaq")
support = os.environ.get("Dueclaion")
sahib = os.environ.get("Dueclaion")
