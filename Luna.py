...
async def handler(event):
  await event.edit("🤗Salam.6372 Sən Mənimlə Sayı Tahmin Edə Bilərsən🤩.Bot 1 dən 500 ə Qədər Bir Sayı Seçir🔢 Ve İstifadəçiler O Sayıyı Tapmağa Çalışır.🎮Oynamaq Üçün /sayi Komandasını Yerinə Yetirin." , buttons=(
    [Button.inline('🔙Geri', data="help")]
    ),
    link_preview = False)
#Temalarr						
